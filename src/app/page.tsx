...
export default function Example() {
  ...
  return (
    <div className="bg-gray">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Here at Premium Platforming, our commitment is to ensure the utmost satisfaction for our customers with each and every product. Explore our diverse range of items crafted to elevate your Roblox events to new heights!
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="/products"
                className="rounded-md bg-gray-900 px-3.5 py-2.5 text-sm font-semibold text-gray shadow-sm hover:bg-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Products
              </a>
      ...
      <div className="bg-black-100 py-24 sm:py-32 lg:py-40">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-2xl mx-auto lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-white-900 sm:text-4xl">Our Features</h2>
            <p className="mt-6 text-lg leading-8 text-white-600">
              Discover the capabilities we offer to help you excel.
            </p>
          </div>
          <div className="mt-10 grid max-w-lg gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-gray-900">
                  <feature.icon aria-hidden="true" className="h-6 w-6 text-gray" />
                </div>
